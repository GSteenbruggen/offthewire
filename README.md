...
<p align="center">
  <a href="https://github.com/GSteenbruggen/offthewire/releases/download/v1.5.0/OffTheWire-Setup-1.5.0.exe"><strong>Windows (x64)</strong></a>
  ·
  <a href="https://github.com/GSteenbruggen/offthewire/releases/download/v1.5.0/OffTheWire-1.5.0-linux-x86_64.tar.gz"><strong>Linux (x86_64)</strong></a>
  ·
  <a href="https://github.com/GSteenbruggen/offthewire/releases/download/v1.5.0/OffTheWire-1.5.0-macos-arm64.tar.gz"><strong>macOS (Apple&nbsp;Silicon)</strong></a>
  <br>
...
```bash
tar -xzf OffTheWire-1.5.0-linux-x86_64.tar.gz
...
```bash
curl -LO https://github.com/GSteenbruggen/offthewire/releases/download/v1.5.0/OffTheWire-1.5.0-macos-arm64.tar.gz
tar -xzf OffTheWire-1.5.0-macos-arm64.tar.gz
...
| `--max-steps N` | Tool calls allowed per turn. Default unlimited; pass a number to cap it. |
...
| `/maxsteps [n]` | Show or change the tool-call limit per turn. Unlimited by default — Ctrl+C and the repeated-call guard are the protections — a number caps it; `unlimited` (or `0`) removes the cap again. |
